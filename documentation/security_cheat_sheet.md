...
<!-- TOC --><a name="docker-security-cheat-sheet"></a>
...
<!-- TOC --><a name="rule-0-keep-host-and-docker-up-to-date"></a>
...
<!-- TOC --><a name="rule-1-do-not-expose-the-docker-daemon-socket-even-to-the-containers"></a>
...
<!-- TOC --><a name="rule-2-set-a-user"></a>
### RULE \#2 - Set a user
...
<!-- TOC --><a name="rule-3-limit-capabilities-grant-only-specific-capabilities-needed-by-a-container"></a>
...
<!-- TOC --><a name="rule-4-prevent-in-container-privilege-escalation"></a>
...
<!-- TOC --><a name="rule-5-be-mindful-of-inter-container-connectivity"></a>
...
<!-- TOC --><a name="rule-6-use-linux-security-module-seccomp-apparmor-or-selinux"></a>
...
<!-- TOC --><a name="rule-7-limit-resources-memory-cpu-file-descriptors-processes-restarts"></a>
...
<!-- TOC --><a name="rule-8-set-filesystem-and-volumes-to-read-only"></a>
...
<!-- TOC --><a name="rule-9-integrate-container-scanning-tools-into-your-cicd-pipeline"></a>
...
<!-- TOC --><a name="rule-10-keep-the-docker-daemon-logging-level-at-info"></a>
...
<!-- TOC --><a name="rule-11-run-docker-in-rootless-mode"></a>
...
<!-- TOC --><a name="rule-12-utilize-docker-secrets-for-sensitive-data-management"></a>
...
<!-- TOC --><a name="rule-13-enhance-supply-chain-security"></a>
...
<!-- TOC --><a name="podman-as-an-alternative-to-docker"></a>
...
<!-- TOC --><a name="references-and-further-reading"></a>
