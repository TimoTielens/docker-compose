...
- [Understanding PUID and PGID](#understanding-puid-and-pgid)
   * [Why use these?](#why-use-these)
   * [Using the variables](#using-the-variables)

<!-- TOC end -->

<!-- TOC --><a name="understanding-puid-and-pgid"></a>
# Understanding PUID and PGID

<!-- TOC --><a name="why-use-these"></a>
## Why use these?
...
<!-- TOC --><a name="using-the-variables"></a>
## Using the variables
...
The following command can be used to create a new user with it's own group
```shell
